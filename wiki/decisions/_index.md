...
`design-decisions`, `hooks`, `skills`, `versioning`, `execution-modes`, `quality-gates`, `cost-limit`, `stage-failure`, `completion-log`, `edge-cases`, `pretooluse`, `stage-gate`, `latency`, `recursive-hooks`, `plan-generation`, `aicp`, `localai`, `claude`, `routing`, `local-first`
