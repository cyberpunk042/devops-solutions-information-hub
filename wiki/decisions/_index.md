...
`hooks`, `design-decisions`, `skills`, `pretooluse`, `stage-gate`, `latency`, `recursive-hooks`, `plan-generation`, `aicp`, `localai`, `claude`, `routing`, `local-first`, `cost-optimization`, `backend-selection`, `complexity-scoring`, `wiki-pipeline`, `mcp`, `cli`, `tool-integration`
