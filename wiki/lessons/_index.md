...
- [Claude Code settings.local.json hot-reloads; settings.json caches at session start](01_drafts/claude-code-settings-local-hot-reload-vs-settings-cache.md) — 
