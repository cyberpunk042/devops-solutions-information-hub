...
- [P5 Candidate Hypothesis — Defense-in-Depth Required for Cross-Cutting Failure Modes](01_drafts/p5-candidate-defense-in-depth-required-for-cross-cutting-failure-modes-hypothesis.md) — The /opt second-brain has 4 validated governing principles (per CONTEXT
...
`lesson`, `sister-project-applicable`, `layer-2`, `contributed`, `methodology`, `inbox`, `quality`, `mission-2026-05-06`, `failure-lesson`, `day-arc-2026-05-08`, `p4-specialization`, `multi-day-pain-point-resolution`, `behave-from-not-over`, `claude-code`, `second-brain`, `structural-enforcement-pending`, `cross-domain`, `hooks`, `openarms`, `enforcement`
