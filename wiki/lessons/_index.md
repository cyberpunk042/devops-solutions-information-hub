...
`failure-lesson`, `quality`, `methodology`, `llm-wiki`, `second-brain`, `orchestration`, `cross-domain`, `claude-code`, `automation`, `maintenance`, `skills`, `compounding-knowledge`, `lesson`, `standards`, `knowledge-graph`, `openfleet`, `harness-engineering`, `planning`, `agent-behavior`, `validation`
