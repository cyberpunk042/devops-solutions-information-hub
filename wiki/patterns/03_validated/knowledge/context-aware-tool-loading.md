...
### Tier-Based Context Depth: Deferred Loading Applied to Agent Context

The pattern extends beyond tool schemas into agent context injection itself. OpenFleet implements tier-based context depth where the AMOUNT of task context an agent receives depends on its demonstrated reliability:

> [!info] Context depth by tier
> | Tier | Task detail | Contributions | Protocol | Events |
> |------|-----------|---------------|----------|--------|
> | Expert | Full | Full inline | Full MUST/MUST NOT | 10 |
