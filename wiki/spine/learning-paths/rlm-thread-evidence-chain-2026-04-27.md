...
> | # | Read | Why |
> |---|---|---|
> | 1 | [Anti-vendor-lock-in lesson](../../lessons/01_drafts/anti-vendor-lock-in-is-an-empirical-claim-when-every-stack-layer-has-paper-evidence.md) Evidence 6 | The mission claim being audited — 4 public benchmarks define the task class, all at Layer 1 |
...
> | 12 | [Anti-vendor-lock-in lesson](../../lessons/01_drafts/anti-vendor-lock-in-is-an-empirical-claim-when-every-stack-layer-has-paper-evidence.md) | Layer-4 evolved-knowledge distillation — mission-claim verification specializes Principle 4 | S1 |
...
> | 19 | [Anti-vendor-lock-in lesson Evidence 6 enrichment](../../lessons/01_drafts/anti-vendor-lock-in-is-an-empirical-claim-when-every-stack-layer-has-paper-evidence.md) | Lesson edit (NEW S2) — Evidence 6 enriched with 4-of-4 Layer-1 grounding | S2 |
...
> 5. **The mission alignment, fully grounded**: every layer of the post-Anthropic stack has direct paper evidence in the wiki — anti-vendor-lock-in is empirically traceable end-to-end at Layer 1 (per the [anti-vendor-lock-in lesson Evidence 6](../../lessons/01_drafts/anti-vendor-lock-in-is-an-empirical-claim-when-every-stack-layer-has-paper-evidence.md))
