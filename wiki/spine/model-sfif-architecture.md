...
1. **Scaffold → Foundation → Infrastructure → Features** (`wiki/patterns/scaffold-foundation-infrastructure-features.md`)
...
2. **Skyscraper, Pyramid, Mountain** (`wiki/domains/cross-domain/skyscraper-pyramid-mountain.md`)
...
3. **Four-Project Ecosystem** (`wiki/domains/devops/four-project-ecosystem.md`)
...
5. **Progressive Distillation** (`wiki/patterns/progressive-distillation.md`)
