...
1. **Research Pipeline Orchestration** (`wiki/domains/automation/research-pipeline-orchestration.md`)
...
2. **Wiki Event-Driven Automation** (`wiki/domains/automation/wiki-event-driven-automation.md`)
...
3. **AI-Driven Content Pipeline** (`wiki/domains/automation/ai-driven-content-pipeline.md`)
...
4. **Claude Code Scheduling** (`wiki/domains/automation/claude-code-scheduling.md`)
...
5. **Plan Execute Review Cycle** (`wiki/patterns/plan-execute-review-cycle.md`)
...
6. **Multi-Stage Ingestion Beats Single-Pass Processing** (`wiki/lessons/lesson-convergence-on-wiki-ingestion-pipeline.md`)
...
7. **Automated Knowledge Validation Prevents Silent Wiki Decay** (`wiki/lessons/lesson-convergence-on-llm-knowledge-linting.md`)
...
8. **Decision: Polling vs Event-Driven Change Detection** (`wiki/decisions/polling-vs-event-driven-change-detection.md`)
...
9. **Decision: MCP vs CLI for Tool Integration** (`wiki/decisions/mcp-vs-cli-for-tool-integration.md`)
