...
`standards`, `spine`, `quality`, `exemplar`, `page-type`, `model`, `reference`, `methodology`, `domain-overview`, `gold-standard`, `navigation`, `anti-patterns`, `learning-path`, `aicp`, `skills`, `concept`, `second-brain`, `ecosystem`, `integration`, `sub-model`
