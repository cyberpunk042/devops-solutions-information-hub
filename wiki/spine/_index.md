...
- [Peace Machine + Core Law — sovereign AI workstation doctrine](doctrine/peace-machine-and-core-law.md) — This page is the doctrinal anchor for the two ultimate solutions (selfdef + sovereign-os) being built across the cybe...
...
- [Learning Path — Custom-Tailored Senior-Engineer-Tier Model Group + Recreated Intelligence Layer (Mission Arc 2026-05-04)](learning-paths/custom-tailored-senior-engineer-tier-model-group-2026-05-04.md) — This learning path navigates the operator-authored 2026-05-04 mission arc: **a custom-tailored senior-engineer-tier m...
...
- [Learning Path — Multi-Day Pain-Point Resolution + 13-Gate Composition (Mission Arc 2026-05-08)](learning-paths/multi-day-pain-point-resolution-13-gate-composition-2026-05-08.md) — This learning path navigates the 26 wiki artifacts authored 2026-05-08 in response to a 64-hour /root failed-conversa...
- [Learning Path v2 — Multi-Day Pain-Point Resolution Comprehensive 9-Phase Body of Work (Mission Arc 2026-05-08)](learning-paths/multi-day-pain-point-resolution-9-phase-comprehensive-2026-05-08-v2.md) — This learning path navigates the complete 52-piece body of work authored 2026-05-08 across 9 work phases (aggregate /...
- [Learning Path — Post-Anthropic 3-Layer Stack Assembly (Multica + Harness + AICP, Session Arc 2026-04-28)](learning-paths/post-anthropic-3-layer-stack-2026-04-28.md) — Curated reading order for the **~12 wiki artifacts** produced during the 2026-04-28 session arc that assembled the po...
- [Learning Path — RLM Thread Evidence Chain (Session Arc 2026-04-27)](learning-paths/rlm-thread-evidence-chain-2026-04-27.md) — Curated reading order for the **16 wiki artifacts** produced during the 2026-04-27 session arc (initially 11 in Sessi...
...
- [The 2026 Consumer-Hardware AI Stack — Strategic Synthesis](references/2026-consumer-hardware-ai-stack.md) — Between late 2024 and mid-2026, four independent layers of the AI stack crossed the consumer-hardware feasibility thr...
...
- [AI Infrastructure Decision Framework 2026 — Full Landscape × Cost × Capability × Privacy](references/ai-infrastructure-decision-framework-2026.md) — The 2026 AI-infrastructure landscape has one dominant empirical finding: **cost-optimization and sovereignty-insuranc...
- [AI Model × Provider × Harness Decision Matrix 2026](references/ai-model-provider-harness-decision-matrix-2026.md) — Single-page lookup to pick (harness, model, provider) triples for any workload
- [Consumer Integration Roadmap — OpenArms Exemplar (First Full Plan)](references/consumer-integration-roadmap-exemplar.md) — The first concrete milestone-level plan for a consumer project integrating with the second brain
...
- [Local Training Playbook 2026 — Wiki Alignment, Tool Calls, Semantic Enhancement](references/local-training-playbook-2026.md) — **Direct answers to operator's three training questions (2026-04-23):**
...
- [Root Documentation Map — Repository-Level Files](references/root-documentation-map.md) — The repository root contains 8 documentation files (3,044 total lines as of 2026-04-28) that serve as the entry point...
...
- [Super-Model — Research Wiki as Ecosystem Intelligence Hub](super-model/super-model.md) — This is the super-model — the packaging of all 16 models, 26 standards pages, and the full knowledge architecture int...
