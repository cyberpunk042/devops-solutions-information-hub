...
`standards`, `spine`, `quality`, `exemplar`, `page-type`, `model`, `reference`, `methodology`, `domain-overview`, `gold-standard`, `anti-patterns`, `navigation`, `aicp`, `skills`, `concept`, `learning-path`, `second-brain`, `ecosystem`, `integration`, `sub-model`
