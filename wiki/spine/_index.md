...
- [Model: Methodology](model-methodology.md) — The Methodology model defines the composable, selectable, nestable system of work processes that governs HOW all work...
...
`spine`, `model`, `learning-path`, `methodology`, `standards`, `transferable`, `ecosystem`, `model-definition`, `skills`, `hooks`, `context-management`, `harness-engineering`, `mcp`, `design-md`, `aicp`, `integration`, `architecture`, `second-brain`, `quality`, `adoption`
