...
> [!info] Official skills from the Obsidian creator
> This repository carries special authority as it comes from Kepano, the founder and primary developer of Obsidian. These represent the canonical way to teach AI agents about Obsidian-specific formats and capabilities.
...
> [!tip] Defuddle skill for token-efficient web ingestion
> The defuddle skill extracts clean markdown from web pages, removing clutter. This is specifically designed to save tokens when feeding web content into LLMs, directly supporting the LLM Wiki Pattern's ingestion workflow.
