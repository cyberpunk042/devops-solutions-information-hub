...
| VFIO with `vfio-pci.ids=10de:2684,10de:22ba` | Verified | `10de:2684`/AD102 was the RTX 3090 (Ampere) id; the RTX 4090 is AD102 (typically `10de:2684`). Pattern is correct; **the id values must be re-derived from `lspci -nn` on the real 4090.** |
