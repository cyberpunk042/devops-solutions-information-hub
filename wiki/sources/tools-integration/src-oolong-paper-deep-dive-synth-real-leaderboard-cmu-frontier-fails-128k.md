...
15. **OOLONG complements rather than duplicates RULER/HELMET/ZeroSCROLLS/etc.** Per §5 related works positioning:
    ...
    **The benchmark is designed to fill a gap, not duplicate existing efforts.** This matters for the [[anti-vendor-lock-in-is-an-empirical-claim-when-every-stack-layer-has-paper-evidence|anti-vendor-lock-in lesson Evidence 6]]: the 4 RLM Table 1 benchmarks are NOT redundant — they span 4 distinct complexity classes.
...
> [!success] **Evidence 6 of [[anti-vendor-lock-in-is-an-empirical-claim-when-every-stack-layer-has-paper-evidence|anti-vendor-lock-in lesson]] is now Layer 1 on the OOLONG side**
>
