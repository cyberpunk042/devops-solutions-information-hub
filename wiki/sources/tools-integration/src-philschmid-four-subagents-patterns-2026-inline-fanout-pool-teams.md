...
The pattern quartet adds a substitutability dimension WITHIN the orchestrator layer (per [Evidence 10 — Multica](../../lessons/01_drafts/anti-vendor-lock-in-is-an-empirical-claim-when-every-stack-layer-has-paper-evidence.md)). Substitutable axes within the orchestration-pattern dimension:
