...
sources:
  ...
  - id: unsloth-synth
    ...
    description: "Unsloth Synthesis — production deployment of UD-IQ2 / Q2_K weight quantization on consumer hardware (RTX 3090 24GB); this synthesis documents the algorithmic foundation Unsloth implements"
  ...
  - id: custom-model-concept
    ...
    description: "Custom-Tailored Model Group Concept — M002 specialist LoRA on RTX 3090 needs Q4KM-class quantization to fit 27B-class bases; this synthesis documents the substrate"
tags: [synthesis, quantization, outliers, llm-int8, smoothquant, gptq, awq, gguf, k-quants, nf4, q4km, q2k, ud-iq2, weight-compression, layer-5-compression, mission-2026-05-08, layer-1, paper-grade, dettmers, consumer-hardware, rtx-3090-substrate, anti-vendor-lock-in-evidence]
---
...
>
> **Stay above the cliff (4-bit minimum for typical models) and the cost is small. Below 3-bit, the cliff is real.** This is the basis for the operator's M002 specialist LoRA target (Q4_K_M on RTX 3090).
...
>
> **Operator-mission directly aligned**: M002 specialist LoRA on Qwen3.6-27B (per [Custom-Model Concept](../../domains/cross-domain/custom-tailored-senior-engineer-tier-model-group-with-recreated-intelligence-layer-research-synthesis.md) Phase 2) at Q4KM fits comfortably in RTX 3090's 24GB VRAM with substantial headroom for KV cache + LoRA adapters.
...
[Multi-Layer Compression Lesson](../../lessons/01_drafts/end-to-end-compression-across-the-ai-stack-composes-multiplicatively-6-plus-independent-mechanisms-at-6-distinct-layers.md) lists Layer 5 (Model weights) substitutable mechanisms: BF16 baseline · FP8 · GGUF Q4_K_M · MXFP4 (gpt-oss-style) · Unsloth UD-IQ2 / Q2_K · Cloudflare Unweight (22% lossless).
...
[Anti-Vendor-Lock-In Lesson Evidence 11 (Trust-Layer)](../../lessons/01_drafts/anti-vendor-lock-in-is-an-empirical-claim-when-every-stack-layer-has-paper-evidence.md) lists "Compression substrate" with Caveman + Unsloth + KV-cache. This synthesis enriches the operator's substitutability menu at Layer 5 (Model weights):
...
> The structural pattern (multiple algorithms, one root cause, convergent-pattern within a layer) parallels the [Multi-Layer Compression Lesson](../../lessons/01_drafts/end-to-end-compression-across-the-ai-stack-composes-multiplicatively-6-plus-independent-mechanisms-at-6-distinct-layers.md)'s cross-layer convergence. **Default proposal**: capture as Layer-2 lesson "Convergent-pattern within a single layer reveals the root cause"; promote candidate.
