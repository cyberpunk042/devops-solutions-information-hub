...
[[end-to-end-compression-across-the-ai-stack-composes-multiplicatively-6-plus-independent-mechanisms-at-6-distinct-layers|Multi-Layer Compression Lesson]] currently lists 11 mechanisms. **DFlash adds the 13th** at the inference-paradigm cross-cutting layer (sister to RLM at Evidence 12):
...
> Per [[end-to-end-compression-across-the-ai-stack-composes-multiplicatively-6-plus-independent-mechanisms-at-6-distinct-layers|Multi-Layer Compression Lesson Composition Math]], mechanisms compose multiplicatively when independent. DFlash + Caveman + UD-IQ2 + KV-cache compression could compound: drafter speedup × prompt compression × weight quantization × cache compression. Empirical validation: M006 of Custom-Model Epic.
