...
Per [[anti-vendor-lock-in-is-an-empirical-claim-when-every-stack-layer-has-paper-evidence|Anti-Vendor-Lock-In Lesson Evidence 14]]: operator currently uses OpenRouter for K2.6 access (per-token, faster than Ollama Cloud as of 2026-05-06 empirical). **Comparison**:
