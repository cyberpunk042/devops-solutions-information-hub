...
- [SRP Trinity — Pulse, Weaver, Auditor](concept-srp-trinity-pulse-weaver-auditor.md) — The **SRP Trinity** is the founding software architecture of the [[src-sain-01-sovereign-node-spec|SAIN-01 Sovereign ...
- [Concept — The Declarative Agent Programming Spectrum: 5 layers (SDD · Skills · Context/Context-Injection · Hooks · Harness) unified, with integration matrix across tools (Claude OS · Multica · OpenClaw · Claude Code · OpenCode · Hermes · Codex · Gemini) and destinations (Wiki LLM · PM tools)](declarative-agent-programming-spectrum-five-layers-spec-skill-context-hook-harness-unified-and-integration-matrix-across-tools.md) — A unification concept that resolves the operator's 2026-05-09 observation — *"SDD and Skills workflow overlap a lot, ...
...
`claude-code`, `skills`, `hooks`, `ai-agents`, `harness-engineering`, `openfleet`, `multi-agent`, `orchestration`, `openclaw`, `subagents`, `commands`, `memory`, `context-engineering`, `context-management`, `automation`, `context-injection`, `deterministic-brain`, `fleet-management`, `mission-control`, `stage-gating`
