...
> [[knowledge-evolution-pipeline|Knowledge Evolution Pipeline]] [[progressive-distillation|Progressive Distillation]] [[model-automation-pipelines|Model — Automation and Pipelines]] Model: Local AI ($0 Target) [[wiki-first-with-lightrag-upgrade-path|Decision — Wiki-First with LightRAG Upgrade Path]]
>
