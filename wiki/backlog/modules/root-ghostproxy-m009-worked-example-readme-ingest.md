---
title: "root-ghostproxy M009 — Worked Example: Ingest README into Second Brain"
aliases:
...
- BLOCKED BY: [[root-ghostproxy-m008-smoke-test-from-inside|M008 — Smoke test (connection must be working)]]
- RELATES TO: [[root-ghostproxy-m001-author-claude-md-and-agents-md|M001 — README is ideally updated before M009 ingests it]]
- ENABLES: [[root-ghostproxy-m010-sister-projects-yaml-flip|M010 — sister-projects.yaml auto-connect decision]]
