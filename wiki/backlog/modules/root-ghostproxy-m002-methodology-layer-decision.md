---
title: "root-ghostproxy M002 — Methodology Layer Decision"
aliases:
  - "M002 — root-ghostproxy methodology layer"
type: module
domain: backlog
status: draft
priority: P0
...
tags: [module, p0, root-ghostproxy, sfif-scaffold-design, methodology, goldilocks, m002]
---

# M002 — Methodology Layer Decision for root-ghostproxy
...
- BLOCKED BY: [[root-ghostproxy-m001-author-claude-md-and-agents-md|M001 — CLAUDE.md / AGENTS.md (decision lands here)]]
- ENABLES: [[root-ghostproxy-m003-foundation-hardening|M003 — Foundation hardening (uses chosen methodology for gates)]]
