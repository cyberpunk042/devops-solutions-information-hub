...
acceptance_criteria:
  ...
  - "EXTENDED 2026-04-28 — RTX 4090 (renewed, ETA mid-May 2026) integrated as local-tier hardware: local Ollama, Qwen3.6-27B at UD-IQ2, RLM-Qwen3-8B from `mit-oasys/rlm-qwen3-8b-v0.1` all running locally on 24GB"
  ...
  - "EXTENDED 2026-04-30 — 4th substitutable layer (trust / confidential-compute) operational: compressed-encrypted weights + on-GPU decypher kernels (Triton) deliver 80-90% space saved on large context, seamless and performance-positive on RTX 4090; L3 additive (NVIDIA H100/H200 CC mode + attestation) available when H100-class hardware is rented or acquired"
