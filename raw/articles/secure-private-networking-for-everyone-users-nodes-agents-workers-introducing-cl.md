...
Source: https://blog.cloudflare.com/mesh/
Ingested: 2026-05-06
Type: article
...
---
description: Cloudflare Mesh provides secure, private network access for users, nodes, and autonomous AI agents. By integrating with Workers VPC, developers can now grant agents scoped access to private databases and APIs without manual tunnels.

title: Secure private networking for everyone: users, nodes, agents, Workers — introducing Cloudflare Mesh
image: https://cf-assets.www.cloudflare.com/zkvhlag99gkb/4bBBEBOns9WUhuWSGfYNwI/ae5f5bb9115155c25cee642c03a4678d/BLOG-3215_OG.png
---
...
* [![Nikita Cano](https://blog.cloudflare.com/cdn-cgi/image/format=auto,dpr=3,width=64,height=64,gravity=face,fit=crop,zoom=0.5/https://cf-assets.www.cloudflare.com/zkvhlag99gkb/6hGB1W3bIJaibV4F7Qe0L8/56f554eeae28828297135a54eacc3065/nikita.jpeg)](https://blog.cloudflare.com/author/nikita/)  
...
This post is also available in [简体中文](https://blog.cloudflare.com/zh-cn/mesh), [Français](https://blog.cloudflare.com/fr-fr/mesh), [Deutsch](https://blog.cloudflare.com/de-de/mesh), [Italiano](https://blog.cloudflare.com/it-it/mesh), [日本語](https://blog.cloudflare.com/ja-jp/mesh), [한국어](https://blog.cloudflare.com/ko-kr/mesh), [Español (Latinoamérica)](https://blog.cloudflare.com/es-la/mesh), [Español](https://blog.cloudflare.com/es-es/mesh) and [繁體中文](https://blog.cloudflare.com/zh-tw/mesh).

![](https://cf-assets.www.cloudflare.com/zkvhlag99gkb/7dyrjyTkHrya7wNTkXOYZy/785fa3450c08e430f544dc049a72f779/BLOG-3215_1.png)
...
If you’re using [Cloudflare One’s SASE and Zero Trust suite](https://www.cloudflare.com/sase/), you already have access to Mesh. You don’t need a new technology paradigm to secure agentic workloads. You need a SASE that was built for the agentic era, and that’s Cloudflare One. Cloudflare Mesh is a new experience with a simpler setup that leverages the on-ramps you’re already familiar with: WARP Connector _(now called a Cloudflare Mesh node)_ and WARP Client _(now called Cloudflare One Client)_. Together, these create a private network for human, developer, and agent traffic. Mesh is directly integrated into your existing Cloudflare One deployment. Your existing Gateway policies, Access rules, and device posture checks apply to Mesh traffic automatically.
...
[Agents Week](https://blog.cloudflare.com/tag/agents-week/)[Developers](https://blog.cloudflare.com/tag/developers/)[Developer Platform](https://blog.cloudflare.com/tag/developer-platform/)[Workers AI](https://blog.cloudflare.com/tag/workers-ai/)[Cloudflare Workers](https://blog.cloudflare.com/tag/workers/)[AI](https://blog.cloudflare.com/tag/ai/)[Zero Trust](https://blog.cloudflare.com/tag/zero-trust/)[Cloudflare One](https://blog.cloudflare.com/tag/cloudflare-one/)[SASE](https://blog.cloudflare.com/tag/sase/)

Follow on X

Thomas Gauvin|[thomasgauvin](https://x.com/thomasgauvin)
